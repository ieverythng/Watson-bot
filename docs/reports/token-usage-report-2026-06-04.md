...
| Window | Used | Limit | % Used |
|---|---|---|---|
| 5hr input | 1,836,449 | TBD | — |
| Weekly total | 5,700,335 | TBD | — |

> ⚠️ No hard limits configured yet. Juan should define daily/weekly token budgets for gpt-5.4 delegation to prevent runaway costs.
