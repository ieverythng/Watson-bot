# Main PC OM Validation - 2026-02-25T21-53-55Z
...
- ram: 7.7Gi
- home: /home/juanbeck
- openclaw-memory-dir: /home/juanbeck/.openclaw/memory
...
│ Gateway         │ local · ws://127.0.0.1:18890 (local loopback) · reachable 14ms · auth token · ULTIMATE-MACHINE    │
...
Summary: 1 critical · 2 warn · 1 info
  ...
  WARN Credentials dir is readable by others
    /home/juanbeck/.openclaw/credentials mode=755; credentials and allowlists can be sensitive.
    Fix: chmod 700 /home/juanbeck/.openclaw/credentials
...
### Next actions
1. Configure embeddings provider in OpenClaw on this host.
...
## $ openclaw memory search --query "Juan Bendek"
```
No matches.
```
exit_code: 0

## $ openclaw memory search --query "staged workflow"
```
No matches.
```
exit_code: 0

## $ openclaw memory search --query "Observational Memory"
```
No matches.
```
exit_code: 0
